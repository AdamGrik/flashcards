export const tcozQuestions = [
  {
    ...
    questions: [
      ...
      {
        question: "Vyberte správne tvrdenie o RC oscilátore",
        options: [
          "Je menej stabilný ako iné typy oscilátorov",
          "Jeho frekvencia je určená Thomsonovým vzťahom",
          "Používa sa pre vysoké frekvencie",
          "Generujú impoulzný výstupný signál",
        ],
        answer: "Je menej stabilný ako iné typy oscilátorov",
      },
      {
        question: "Na obrázku je VA charakteristika:",
        options: ["Diaku", "Tyristoru", "Triaku"],
        image: "obr27",
        answer: "Diaku",
      },
      {
      ...
      {
        question: "Na obrazku je zapojenie pomocou tranzistorov:",
        options: [
          "Logického členu AND",
          "Logického členu OR",
          "Logického členu NAND",
          "Logického členu NOR",
        ],
        image: "obr30",
        answer: "Logického členu AND",
      },
      {
        question: "Na obrázku je pravdivostná tabuľka:",
        options: [
          "Logického členu AND",
          "Logického členu OR",
          "Logického členu NAND",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question:
          "Ktoré vrstvy OSI modelu patria do aplikačného TCP/IP modelu ?",
        options: [
      ...
      {
        question:
          "Ktorá z nasledujúcich IP adries patrí medzi súkromné adresy ?",
      ...
      {
        question:
          "Ktorá komunikácia posiela správu najviac jednému zariadeniu ?",
        options: [
          "Anycast",
          "Unicast a broadcast",
          "Anycast a unicast",

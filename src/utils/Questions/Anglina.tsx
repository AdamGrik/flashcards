...
{
  question: " I wouldn't lend you my book if you ________ to bring yours.",
...
{
  question: " The policeman asked the man if he ________ seen anything strange.",
  options: ["have", "did", "had"],
  answer: "had"
},
{
  question: " His car wouldn't have been broken if he hadn't ________ to check the oil.",
...
{
  question: " A sewer system is a system of .... below the level of the ground.",
